      ...
      <div className="container relative z-30">
        ...
        <form className="mt-6 flex flex-col justify-center sm:flex-row">
          <input
            ...
            disabled
          />
          <button disabled className="mt-2 rounded bg-yellow px-8 py-3 font-body text-base font-bold uppercase text-primary transition-colors hover:bg-primary hover:text-white focus:border-transparent focus:outline-none focus:ring focus:ring-yellow sm:ml-2 sm:mt-0 sm:py-4 md:text-lg">
            Join the club
          </button>
        </form>
      </div>
